...
# Count for each file
files = [
    'D:/02_School/MSc/02_Sem2627-2/MultiModal/MultiModal_Assignment/input/small_lookup_cryptic_group.tsv',
    'D:/02_School/MSc/02_Sem2627-2/MultiModal/MultiModal_Assignment/input/cryptic_bidirectional.tsv', 
    'D:/02_School/MSc/02_Sem2627-2/MultiModal/MultiModal_Assignment/input/cryptic_transitive.tsv'
]

results = {}
for file in files:
    try:
        results[file] = analyze_connections(file)
